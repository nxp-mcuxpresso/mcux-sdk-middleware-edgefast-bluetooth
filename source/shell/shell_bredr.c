...
static NET_BUF_POOL_FIXED_DEFINE(data_pool, DATA_BREDR_COUNT, DATA_BREDR_MTU, CONFIG_NET_BUF_USER_DATA_SIZE, NULL);

#define SDP_CLIENT_USER_BUF_LEN		512
static NET_BUF_POOL_FIXED_DEFINE(sdp_client_pool, CONFIG_BT_MAX_CONN,
