...
#include "stream.h"
    ...
    (defined(CONFIG_BT_AUDIO_UNICAST) && (CONFIG_BT_AUDIO_UNICAST > 0))
...
#if (defined(UNICAST_GROUP_STREAM_CNT) && (UNICAST_GROUP_STREAM_CNT > 0))
...
#if (defined(BROADCAST_STREAM_CNT) && (BROADCAST_STREAM_CNT > 0))
...
struct bt_audio_broadcast_sink {
	...
	struct bt_iso_big *big;
#if (defined(BROADCAST_SNK_STREAM_CNT) && (BROADCAST_SNK_STREAM_CNT > 0))
