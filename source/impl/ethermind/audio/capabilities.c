...
IF_ENABLED(CONFIG_BT_PAC_SRC, (static enum bt_audio_context source_available_contexts;));
	...
	(defined(CONFIG_BT_ASCS) && (CONFIG_BT_ASCS > 0))
				    ...
				    struct bt_codec_qos_pref *const pref)
{
	...
	SYS_SLIST_FOR_EACH_CONTAINER(lst, cap, _node, struct bt_audio_capability) {
...
#if (defined(CONFIG_BT_PAC_SNK_LOC) && (CONFIG_BT_PAC_SNK_LOC > 0U)) || \
	(defined(CONFIG_BT_PAC_SRC_LOC) && (CONFIG_BT_PAC_SRC_LOC > 0U))

#if (defined(CONFIG_BT_PAC_SNK_LOC) && (CONFIG_BT_PAC_SNK_LOC > 0U))
static enum bt_audio_location sink_location;
#endif /* CONFIG_BT_PAC_SNK_LOC */
#if (defined(CONFIG_BT_PAC_SRC_LOC) && (CONFIG_BT_PAC_SRC_LOC > 0U))
...
#if (defined(CONFIG_BT_PAC_SNK_LOC_WRITEABLE) && (CONFIG_BT_PAC_SNK_LOC_WRITEABLE > 0U)) || \
	(defined(CONFIG_BT_PAC_SRC_LOC_WRITEABLE) && (CONFIG_BT_PAC_SRC_LOC_WRITEABLE > 0U))
...
int bt_audio_capability_unregister(struct bt_audio_capability *cap)
{
    ...
    (defined(CONFIG_BT_PAC_SRC_LOC) && (CONFIG_BT_PAC_SRC_LOC > 0))
				  ...
				  enum bt_audio_context contexts)
{
        ...
        if (dir == BT_AUDIO_DIR_SINK) {
                const enum bt_audio_context supported = (enum bt_audio_context)CONFIG_BT_PACS_SNK_CONTEXT;
        ...
        if (dir == BT_AUDIO_DIR_SOURCE) {
                const enum bt_audio_context supported = (enum bt_audio_context)CONFIG_BT_PACS_SRC_CONTEXT;
				  ...
				  enum bt_audio_context *contexts)
{
	...
	__ASSERT(false, "Invalid endpoint dir: %u", dir);
...
#endif /* CONFIG_BT_AUDIO_CAPABILITY */
