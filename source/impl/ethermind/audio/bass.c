...
#define LOG_ENABLE IS_ENABLED(BT_DEBUG_BASS_CLIENT)
...
{
	printf("ISO Channel %p connected\n", chan);
}

static void iso_disconnected(struct bt_iso_chan *chan, uint8_t reason)
{
	printf("ISO Channel %p disconnected with reason 0x%02x\n", chan, reason);
}
