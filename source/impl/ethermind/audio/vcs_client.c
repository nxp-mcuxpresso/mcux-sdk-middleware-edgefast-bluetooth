...
#define LOG_ENABLE IS_ENABLED(CONFIG_BT_DEBUG_VCS_CLIENT)
...
#if (defined(CONFIG_BT_VCS_CLIENT_AICS) && (CONFIG_BT_VCS_CLIENT_AICS > 0))
...
#if (defined(CONFIG_BT_VCS_CLIENT_VOCS) && (CONFIG_BT_VCS_CLIENT_VOCS > 0))
