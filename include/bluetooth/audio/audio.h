...
struct bt_codec_data {
	struct bt_data data;
#if (defined(CONFIG_BT_CODEC_MAX_DATA_LEN) && (CONFIG_BT_CODEC_MAX_DATA_LEN > 0))
...
struct bt_codec {
	...
	uint16_t vid;
#if (defined(CONFIG_BT_CODEC_MAX_DATA_COUNT) && (CONFIG_BT_CODEC_MAX_DATA_COUNT > 0))
	/** Codec Specific Data count */
	size_t   data_count;
	/** Codec Specific Data */
	struct bt_codec_data data[CONFIG_BT_CODEC_MAX_DATA_COUNT];
#endif /* CONFIG_BT_CODEC_MAX_DATA_COUNT */
#if (defined(CONFIG_BT_CODEC_MAX_METADATA_COUNT) && (CONFIG_BT_CODEC_MAX_METADATA_COUNT > 0))
...
#if (defined(BROADCAST_SNK_SUBGROUP_CNT) && (BROADCAST_SNK_SUBGROUP_CNT > 0))
...
struct bt_audio_pacs_cb {
    ...
    (defined(CONFIG_BT_PAC_SRC_LOC_WRITEABLE) && (CONFIG_BT_PAC_SRC_LOC_WRITEABLE > 0))
