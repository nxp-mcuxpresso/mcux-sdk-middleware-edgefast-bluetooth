...
/*! @brief Microphone Input Control Profile Microphone Device debug
 * Use this option to enable Microphone Input Control Profile Microphone Device debug logs for the Bluetooth Audio functionality.
 */
...
/*! @brief Microphone Input Control Profile Microphone Controller debug
